...
## OpenClaw Notes
- In OpenClaw, this skill is auto-selected when the task is clearly about frontend/UI design work.
- You do not need Codex-specific commands like `$frontend-design`; just ask normally (e.g. "做一個有質感的 landing page" or "幫我把這個 React 頁面改得更有設計感").
- For best results, specify target framework, audience, visual tone, and whether the priority is aesthetics, accessibility, performance, or implementation speed.
